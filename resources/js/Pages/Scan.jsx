            ...
            <main id="scan" className='mt-32'>
                ...
                <div className='flex flex-col gap-5 justify-center items-center mb-36'>
                    ...
                    <div className='flex flex-col divide-y max-w-[1000px]'>
                        {/* Upload 3D model */}
                        <div className='md:px-24 flex flex-col md:flex-row items-center gap-5 md:gap-20 bg-[var(--blue)] text-[var(--white)] p-5 rounded-t-md shadow-lg'>
                            <div className='w-1/2'>
                        ...
                        <div className='md:px-24 flex flex-col md:flex-row items-center gap-5 md:gap-20 bg-[var(--blue)] text-[var(--white)] p-5 shadow-lg'>
                        ...
                        {/* Receive order */}
                        <div className='md:px-24 flex flex-col md:flex-row items-center gap-5 md:gap-20 bg-[var(--blue)] text-[var(--white)] p-5 rounded-b-md shadow-lg'>
                            <div className='flex flex-col items-center gap-7'>
