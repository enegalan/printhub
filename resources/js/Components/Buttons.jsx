...
const BouncingButton = () => {
    return (
        <a href="#thanks" class="animate-bounce mb-[50px] bg-white dark:bg-slate-800 p-2 w-10 h-10 ring-1 self-center ring-slate-900/5 dark:ring-slate-200/20 shadow-lg rounded-full flex items-center justify-center">
